...
AAmmoPickup::AAmmoPickup()
{
	...
	ammoInstance = CreateDefaultSubobject<UAmmoInstance>(TEXT("WeaponInstance"));
...
void AAmmoPickup::InitPickup(class UAmmoDataAsset* initData)
{
	ammoInstance->InitAmmoInstance(initData);
